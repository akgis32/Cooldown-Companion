...
local function BuildTextAppearanceTab(container, group, style)
    ...
    local fmtInfo = CreateInfoButton(fmtHeading.frame, fmtCollapseBtn, "LEFT", "RIGHT", 4, 0, {
        ...
        {"|cff00ff00{time}|r  Cooldown time remaining", 1, 1, 1, true},
        ...
        {"|cff00ff00{pandemic}|r  |cff888888(conditional only)|r Aura in pandemic window", 1, 1, 1, true},
        {"|cff00ff00{proc}|r  |cff888888(conditional only)|r Spell proc overlay active", 1, 1, 1, true},
        {"|cff00ff00{available}|r  |cff888888(conditional only)|r Off cooldown / has charges", 1, 1, 1, true},
        {"|cff00ff00{unusable}|r  |cff888888(conditional only)|r Spell/item not usable", 1, 1, 1, true},
        {"|cff00ff00{oor}|r  |cff888888(conditional only)|r Target out of range", 1, 1, 1, true},
        " ",
        ...
        {"stacks, aura, keybind, pandemic, proc,", 0.5, 0.5, 0.5, true},
        {"unusable, oor, available)", 0.5, 0.5, 0.5, true},
        " ",
